...
Small content size:
	...
	Currently, the ratio of copies to megabytes is approximately 4 to 1, i.e., 4 new models will weigh about 1 MB (including LODs and collisions). This means that with an additional 100 MB of project content size, you can afford approximately 400 scaled versions of assets (maybe less, maybe more - it depends on the asset itself).
