...
Малый размер контента:
	...
	На данный момент соотношение копий к мебагайту примерно 4 к 1, т.е. 4 новых модели будут весить примерно 1 мб (включая лоды и коллизии). Это значит, что на 100 мб дополнительного веса вы сможете позволить себе примерно 400 поскейленных версий ассетов (может меньше, а может больше - зависит от самого ассета).
